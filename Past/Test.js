...
export const run = async () => {
  // Initialize the LLM to use to answer the question.
    ...
    const res = await chain.call({
        query: `Which customers is linked to the most jobs. Jobs are linked to a project. and projects are linked to customers. thus customers are indirectly linked to jobs.
