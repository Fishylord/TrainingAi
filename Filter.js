...
export const run = async () => {
  ...
  Operator Guide:
  1. Number and Text Type Filter Operators 0: Contain,1: Not Contain,2: Equal (Only takes 1 Number No minmax),3:Not Equal.
  ...
  const res = await chain.call({
      query : `SRE Info with the text Sales that were given more than 10% discounts (Can't use Date Search operators) that has around 50-100$ more in collections from activities created by John in a activity between August 1-4th` 
  });
  console.log(res);
